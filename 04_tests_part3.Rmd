...
Pour ce cours nous prendrons un autre exemple concernant le potentiel de stockage du carbon au niveau du **sol** en fonction des types de climats/territoire. Ce travail a fait l'objet d'une publication scientifique dans le Journal *PNAS*. Vous pouvez lire le papier [**ici**](https://www.pnas.org/doi/10.1073/pnas.2111312119).

Les données peuvent être téléchargées [**ici**](https://github.com/DJrMartin/bookdown_applied_statistics/blob/main/data/Carbon-Storage.rda).
...
Les données du TP peuvent être téléchargées [**ici**](https://github.com/DJrMartin/bookdown_applied_statistics/blob/main/data/TPs/iron_metabolism_RNA_TP.csv)
